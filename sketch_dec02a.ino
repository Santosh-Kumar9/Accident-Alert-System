...
const String EMERGENCY_PHONE1 = "+91xxxxxxxxxx";
const String EMERGENCY_PHONE2 = "+91xxxxxxxxxx";
#define rxPin 2
#define txPin 3
...
void parseData(String buff) {
  ...
  if (buff != "OK") {
    ...
    if (cmd == "+CMTI") {
      ...
      if (buff.indexOf(EMERGENCY_PHONE1) > 1) {
        buff.toLowerCase();
        if (buff.indexOf("get gps") > 1) {
          getGps();
          String sms_data;
      ...
      if (buff.indexOf(EMERGENCY_PHONE2) > 1) {
        buff.toLowerCase();
        if (buff.indexOf("get gps") > 1) {
          getGps();
          String sms_data;
